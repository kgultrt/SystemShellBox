    ...
    public void show() {
        new MaterialAlertDialogBuilder(context)
            ...
            .setItems(new String[]{
                ...
                switch (which) {
                    case 0: // Move
                        MoveDialog.show(context, fileItem, executorService, activePanel,
                                        callback::onRenameSuccess); // 移动成功复用重命名回调
                        break;
                    case 1: // Copy
                    ...
                    case 4: // Properties
                        ...
                        break;
                    case 5: // Bookmark
                        BottomMenuClickListener bookmark = new BottomMenuClickListener(Application.getAppContext());
                        bookmark.addToBookmark(fileItem.getFile().getAbsolutePath());
