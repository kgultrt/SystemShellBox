...
final class TermuxPreferences {
    ...
    void reloadFromProperties(Context context) {
        File propsFile = new File(TermuxService.HOME_PATH + "/.term/term.properties");
        if (!propsFile.exists())
            propsFile = new File(TermuxService.HOME_PATH + "/.config/term/term.properties");
        ...
        try {
            ...
            Toast.makeText(context, "Could not open properties file term.properties.", Toast.LENGTH_LONG).show();
