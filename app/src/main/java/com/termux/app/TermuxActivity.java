...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/com.manager.ssb/files/usr/home/.term/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.manager.ssb/files/usr/home/.term/colors.properties");
